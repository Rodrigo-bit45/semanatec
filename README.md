...
## Acerca de
Este es un programa en lenguaje python. Utiliza la cámara del dispositivo donde se corra y le aplica distintos filtros. Se puede utilizar el filtro sepia, gaussiano, escala de grises, entre otros. 
